...
<link rel="stylesheet" type="text/css" href="/style/Keywelt/base.css">
<link rel="stylesheet" type="text/css" href="/style/Keywelt/colorscheme.css">
EOF
...
skin_body_begin() {
	local title=$1 id=$2
	local help=""
	[ -r /usr/share/www/Keywelt/help.sh ] && . /usr/share/www/Keywelt/help.sh && Keywelt_adds
...
<span class="opt">Optimiert f&uuml;r FF, IE9, OPERA, Google CHROME - Skin Design by rolu2 und Keyjockey (Keywelt-Board)</span>
</div>
EOF
}
