...
<link rel="stylesheet" type="text/css" href="/style/Nachtfalke_old/base.css">
<link rel="stylesheet" type="text/css" href="/style/Nachtfalke_old/colorscheme.css">
EOF
...
skin_body_begin() {
	local title=$1 id=$2
	local help=""
	[ -r /usr/share/www/Nachtfalke_old/help.sh ] && . /usr/share/www/Nachtfalke_old/help.sh && Nachtfalke_old_adds
...
<span class="opt">$([ "$lang" == "german" ] && echo 'optimiert f&uuml;r' || echo 'optimized for') FF, IE9, OPERA, Google CHROME - Skin Design by Dunkeltapps (NACHTFALKE Sat-ULC)</span>
</div>
EOF
}
